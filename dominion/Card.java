...
public final class Card implements Comparable<Card>, Cloneable{
	...
	public static List<Card> createCards() {
		...
		ret.add(o);
		o = new Card(CardName.bureaucrat,Type.ACTION,6,0,0);
		ret.add(o);
		o = new Card(CardName.chapel,Type.ACTION,4,0,0);
		ret.add(o);	
		o = new Card(CardName.chancellor,Type.ACTION,3,0,0);
		ret.add(o);
		o = new Card(CardName.council_room,Type.ACTION,6,0,0);
		ret.add(o);
		o = new Card(CardName.feast,Type.ACTION,4,0,0);
		ret.add(o);	
		o = new Card(CardName.festival,Type.ACTION,3,0,0);
		ret.add(o);
		o = new Card(CardName.gardens,Type.ACTION,6,0,0);
		ret.add(o);
		o = new Card(CardName.laboratory,Type.ACTION,4,0,0);
		ret.add(o);	
		o = new Card(CardName.library,Type.ACTION,3,0,0);
		ret.add(o);
